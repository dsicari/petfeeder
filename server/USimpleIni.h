// https://github.com/FragJage/SimpleIni
...
class TSimpleIni
{
    ...
    public:
        ...
        TSimpleIni(const std::string& filename="");
    ...
    private:
        std::map<std::string, std::map<std::string, TSimpleIni::IniLine> > m_IniMap;
...
class TSimpleIni::SectionIterator
{
    public:
        ...
        SectionIterator();
        /// \brief    Constructor of a section iterator
        /// \details  Constructor to declare a section iterator, call by TSimpleIni::BeginSection
        SectionIterator(std::map<std::string, std::map<std::string, TSimpleIni::IniLine> >::iterator mapIterator);
    ...
    private:
        std::map<std::string, std::map<std::string, TSimpleIni::IniLine> >::iterator m_mapIterator;
};

/// \brief    Key iterator for TSimpleIni class
/// \details  Class to browse keys of a configuration file load by TSimpleIni class.
class TSimpleIni::KeyIterator
{
    public:
        ...
        KeyIterator();
        /// \brief    Constructor of a key iterator
        /// \details  Constructor to declare a key iterator, call by TSimpleIni::BeginKey
        KeyIterator(std::map<std::string, TSimpleIni::IniLine>::iterator mapIterator);
        /// \brief    Overloading dereference operator
    ...
    private:
        std::map<std::string, TSimpleIni::IniLine>::iterator m_mapIterator;
};
