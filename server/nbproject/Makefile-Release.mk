...
${OBJECTDIR}/ULog.o: ULog.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ULog.o ULog.cpp

${OBJECTDIR}/UMySqlConnector.o: UMySqlConnector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UMySqlConnector.o UMySqlConnector.cpp

${OBJECTDIR}/UNetworkUDPServer.o: UNetworkUDPServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UNetworkUDPServer.o UNetworkUDPServer.cpp

${OBJECTDIR}/USimpleIni.o: USimpleIni.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/USimpleIni.o USimpleIni.cpp
