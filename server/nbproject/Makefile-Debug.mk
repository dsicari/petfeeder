...
# CC Compiler Flags
CCFLAGS=-lmysqlcppconn
CXXFLAGS=-lmysqlcppconn
...
${OBJECTDIR}/ULog.o: ULog.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ULog.o ULog.cpp

${OBJECTDIR}/UMySqlConnector.o: UMySqlConnector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/UNetworkUDPServer.o: UNetworkUDPServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UNetworkUDPServer.o UNetworkUDPServer.cpp

${OBJECTDIR}/USimpleIni.o: USimpleIni.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/USimpleIni.o USimpleIni.cpp

${OBJECTDIR}/UUtil.o: UUtil.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UUtil.o UUtil.cpp
